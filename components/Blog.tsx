  ...
  return (
    ...
    <div className="container">
      <div className="section-title row mb-3">
        ...
        <p>
          we understand that pure water is the only weapon to fight against
          thousands of diseases out in the real world. With a wealth of
          experiences accumulated, we trade and supply water treatment products.
        </p>
      </div>
