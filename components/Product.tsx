      ...
      <div className="container-xl">
        <div className="section-title row">
          ...
          <p>
            ...
            field of water purifier. We are running independently and deals in
            all types of water purifier service such as RO installation, RO
        ...
        <div className="row">
          <div className="col-lg-3 col-md-4 mb-4">
            <a href="detail.html">
              <div className="product bg-white p-4 text-center shadow-md">
                <img className="mah-150" src="images/product/p4.webp" alt="" />
          ...
          <div className="col-lg-3 col-md-4 mb-4">
            <a href="detail.html">
              <div className="product bg-white p-4 text-center shadow-md">
                <img className="mah-150" src="images/product/p1.webp" alt="" />
                <div className="d-inline-block">
          ...
          <div className="col-lg-3 col-md-4 mb-4">
            <a href="detail.html">
              <div className="product bg-white p-4 text-center shadow-md">
                <img className="mah-150" src="images/product/p2.webp" alt="" />
                <div className="d-inline-block">
          ...
          <div className="col-lg-3 col-md-4 mb-4">
            <a href="detail.html">
              <div className="product bg-white p-4 text-center shadow-md">
                <img className="mah-150" src="images/product/p3.webp" alt="" />
                <div className="d-inline-block">
